...
/*******************************calcul类*************************************************************************/
 ...
 void calcul::calcul_overallABC()
 {
	...
	overall_B=calcul::round(all*b_of_location);
	overall_C=all-overall_A-overall_B;
 }
...
void culum::calcul_cost(int NO,int sumA,int sumB,int sumC)
{
